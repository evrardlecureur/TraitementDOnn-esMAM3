...
\subsection{Analyse ciblée : l'effet de l'altitude sur l'acidité selon la région}

Au-delà de la prédiction globale, une seconde modélisation affine la compréhension du lien entre terroir et profil aromatique. Un modèle d'interaction linéaire a été ajusté pour prédire le sous-score \textit{Acidity} en fonction de l'altitude, de la macro-région, et de leur produit croisé :
